...
jQuery(document).ready(function () {
	...
	tinymce.init({
		...
		toolbar: "undo redo formatselect bold italic underline justifyleft justifycenter justifyright justifyfull outdent indent image code link numlist bullist blockquote",
		relative_urls: false,
